 ...
 * @since 0.1.0
 */
class Croatan_Widget_Gallery_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname' => 'croatan-gallery-posts',
			'description' => esc_html__( 'Displays posts from the "gallery" post format.', 'croatan' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget(
			'croatan-gallery-posts',		// $this->id_base
			__( 'Galleries', 'croatan' ),		// $this->name
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Galleries', 'croatan' ),
			'posts_per_page' => 9,
		);

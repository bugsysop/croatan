...
/**
 * Image post format widget class.
 *
 * @since 0.1.0
 */
class Croatan_Widget_Image_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname' => 'croatan-image-posts',
			'description' => esc_html__( 'Displays posts from the "image" post format.', 'croatan' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget(
			'croatan-image-posts',			// $this->id_base
			__( 'Images', 'croatan' ),	// $this->name
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Images', 'croatan' ),
			'posts_per_page' => 9,
		);

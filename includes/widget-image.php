 ...
 * @since 0.1.0
 */
class Croatan_Widget_Image extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array( 
			'classname' => 'image', 
			'description' => __( 'Display an image in any sidebar.', 'croatan' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget( 'image', __( 'Image', 'croatan' ), $widget_options, $control_options );
	}
	...
	function form( $instance ) {
		...
		<div>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'croatan' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'image_url' ); ?>"><?php _e( 'Image <acronym title="Uniform Resource Locator">URL</acronym>:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'alt_text' ); ?>"><?php _e( 'Alternate Text:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image_title' ); ?>"><?php _e( 'Image Title:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image_caption' ); ?>"><?php _e( 'Caption:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image_align' ); ?>"><?php _e( 'Alignment:', 'croatan' ); ?></label> 
			<select style="float:right;max-width:66px;" class="widefat" id="<?php echo $this->get_field_id( 'image_align' ); ?>" name="<?php echo $this->get_field_name( 'image_align' ); ?>">
				<?php foreach ( array( 'alignnone' => __( 'None', 'croatan'), 'aligncenter' => __( 'Center', 'croatan' ), 'alignleft' => __( 'Left', 'croatan' ), 'alignright' => __( 'Right', 'croatan' ) ) as $option_value => $option_label ) { ?>
					<option value="<?php echo $option_value; ?>" <?php selected( $instance['image_align'], $option_value ); ?>><?php echo $option_label; ?></option>
				<?php } ?>
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'image_width' ); ?>"><?php _e( 'Width:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image_height' ); ?>"><?php _e( 'Height:', 'croatan' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link_url' ); ?>"><?php _e( 'Link <acronym title="Uniform Resource Locator">URL</acronym>:', 'croatan' ); ?></label>

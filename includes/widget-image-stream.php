...
class Croatan_Widget_Image_Stream extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array( 
			...
			'description' => __( 'Displays image thumbnails in a gallery-like format.', 'croatan' ) 
		);
		...
		/* Create the widget. */
		$this->WP_Widget( 'image-stream', __( 'Image Stream', 'croatan' ), $widget_options, $control_options );
	}
	...
	function widget( $sidebar, $instance ) {
		...
		if ( $loop->have_posts() ) {
			...
			echo '<p>' . __( 'There are currently no images found.', 'croatan' ) . '</p>';
		}
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Image Stream', 'croatan' ),
			'posts_per_page' => 6,
		);
